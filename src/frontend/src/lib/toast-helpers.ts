...
export const useToastHelpers = () => {
  ...
  return {
    apiSuccess: (operation: string, details?: string) => {
      toast.success(`${operation} successful`, details || `Operation completed successfully`, 5000)
    },
    ...
    networkError: () => {
      toast.error('Network connection error', 'Please check your internet connection and try again.', 10000)
    }
  }
}
