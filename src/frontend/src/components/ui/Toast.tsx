...
import { X, CheckCircle, AlertCircle, AlertTriangle, Info, Terminal } from '@/components/ui/icons'
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          style={{
            boxShadow: `0 0 20px ${toast.type === 'success' ? 'rgba(74, 222, 128, 0.2)' : 
                                toast.type === 'error' ? 'rgba(248, 113, 113, 0.2)' :
                                toast.type === 'warning' ? 'rgba(251, 191, 36, 0.2)' :
                                toast.type === 'info' ? 'rgba(96, 165, 250, 0.2)' :
                                'rgba(0, 255, 255, 0.2)'}`,
          }}
        >
          {/* Progress bar */}
