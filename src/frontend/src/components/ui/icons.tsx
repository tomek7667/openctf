...
const createIcon = (
  ...
  const Icon = React.forwardRef<SVGSVGElement, IconProps>(
    ({ className, size = 20, 'aria-label': ariaLabel, 'aria-hidden': ariaHidden, ...props }, ref) => (
      <svg
        ref={ref}
        width={size}
        height={size}
...
export const LoadingSpinner = createIcon('LoadingSpinner', (
  <>
...
export const Icons = {
  ...
  ArrowLeft, ArrowRight, Search, Filter, MoreHorizontal, Plus, Minus,
  
  // Authentication
  User, Users, LogIn, LogOut, Lock, Unlock,
  
  // CTF & Security
  Shield, ShieldCheck, Trophy, Flag, Target,
  ...
  // Actions & States
  Eye, EyeOff, Star, Heart, Bookmark, Share,
  
  // Communication
  MessageSquare, MessageCircle, Mail, Phone,
  
  // Media & Content
  Image, Video, File, Download, Upload, Link, ExternalLink,
  ...
  // Loading & Status
  Loader, RefreshCw, LoadingSpinner,
