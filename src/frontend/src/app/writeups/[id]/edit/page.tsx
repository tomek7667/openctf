...
import { getWriteup, updateWriteup, deleteWriteup, Writeup } from "@/api/writeups";
...
export default function EditWriteupPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await updateWriteup(writeup.id, writeupData, user?.id?.toString());
      if (response.success && response.data) {
    ...
    return (
      <MainLayout>
        <div className="flex flex-col items-center justify-center min-h-screen">
          <h1 className="text-2xl font-mono text-red-400 mb-4">Writeup not found or access denied</h1>
          <Button onClick={() => router.push('/writeups')}>Go back to writeups</Button>
        </div>
      </MainLayout>
    );
  }
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex items-center justify-center space-x-2 text-green-400">
                ...
                <span className="text-lg font-mono">&gt; Editing: {writeup.title}</span>
              ...
              >
                ...
                >
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="font-mono text-red-400 font-bold text-lg">CONFIRM DELETE</h3>
                  </div>
