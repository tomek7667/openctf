...
| `ALLOWED_ORIGINS`              | CORS origins, should default really to array separated with commas of urls that are hosting the fronted. Default: `http://127.0.0.1:3000` _(development website)_ | [x]                    |
