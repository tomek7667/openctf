...
| `ALLOWED_ORIGINS`              | CORS osrigins, should default really to array separated with commas of urls that are hosting the fronted. Default: `http://127.0.0.1:3000` _(development website)_ | [x]                    |
| `ICLOUD_EMAIL`                 | Checkout [lib website](https://github.com/tomek7667/goimail) for description                                                                                       | [x]                    |
| `ICLOUD_SENDER_EMAIL`          | Checkout [lib website](https://github.com/tomek7667/goimail) for description                                                                                       | [x]                    |
| `ICLOUD_APP_SPECIFIC_PASSWORD` | Checkout [lib website](https://github.com/tomek7667/goimail) for description                                                                                       | [x]                    |
| `NEXT_PUBLIC_API_URL`          | Mainly used for BE external links.                                                                                                                                 | [x]                    |
| `APP_URL`                      | Mainly used for FE external links. Especially useful for crafting e-mails.                                                                                         | [x]                    |
| `GH_CLIENT_SECRET`             | Github Apps integration client secret                                                                                                                              | [x]                    |
| `GH_CLIENT_ID`                 | Github Apps integration app client ID. By default it's the production one: `Iv23litf0P4UDtM8mHCA`.                                                                 | [ ]                    |
