...
func (tq *TeamQuery) QueryCaptain() *UserQuery {
...
func (tq *TeamQuery) WithCaptain(opts ...func(*UserQuery)) *TeamQuery {
	query := (&UserClient{config: tq.config}).Query()
...
func (tq *TeamQuery) loadCaptain(ctx context.Context, query *UserQuery, nodes []*Team, init func(*Team), assign func(*Team, *User)) error {
