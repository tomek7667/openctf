...
// The TeamAchievementFunc type is an adapter to allow the use of ordinary
// function as TeamAchievement mutator.
type TeamAchievementFunc func(context.Context, *ent.TeamAchievementMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TeamAchievementFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TeamAchievementMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TeamAchievementMutation", m)
}
...
// function as WeightRating mutator.
type WeightRatingFunc func(context.Context, *ent.WeightRatingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WeightRatingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WeightRatingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WeightRatingMutation", m)
}
