...
const (
	// Label holds the string label denoting the aggregatedteamdetails type in the database.
	Label = "aggregated_team_details"
	...
	// Table holds the table name of the aggregatedteamdetails in the database.
	Table = "aggregated_team_details"
)

// Columns holds all SQL columns for aggregatedteamdetails fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldDescription,
...
// OrderOption defines the ordering options for the AggregatedTeamDetails queries.
